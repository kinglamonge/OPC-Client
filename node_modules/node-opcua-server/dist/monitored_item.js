...
function safeGuardRegiter(monitoredItem) {
    monitoredItem._$safeGuard = monitoredItem.oldDataValue.toString();
}
function safeGuardVerify(monitoredItem) {
    var _a;
    if (monitoredItem._$safeGuard) {
        const verif = ((_a = monitoredItem.oldDataValue) === null || _a === void 0 ? void 0 : _a.toString()) || "";
...
class MonitoredItem extends events_1.EventEmitter {
    ...
    recordValue(dataValue, skipChangeTest, indexRange) {
        ...
        if (!skipChangeTest) {
            ...
            if (!hasChanged) {
                // istanbul ignore next 
                doDebug && debugLog("recordValue => Rejected ", (_d = this.node) === null || _d === void 0 ? void 0 : _d.browseName.toString(), " because !skipChangeTest && sameDataValue");
                return false;
            }
        }
        ...
        if (useIndexRange) {
            ...
            if ((0, node_opcua_variant_1.sameVariant)(dataValue.value, this.oldDataValue.value)) {
                // istanbul ignore next 
                doDebug && debugLog("recordValue => Rejected ", (_h = this.node) === null || _h === void 0 ? void 0 : _h.browseName.toString(), " because useIndexRange && sameVariant");
                return false;
            }
        }
        // processTriggerItems
